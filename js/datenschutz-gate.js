  ...
  function showDeclineWall() {
    ...
    wall.innerHTML =
      '<div class="datenschutz-decline-inner">' +
        ...
        '<div lang="ar" dir="rtl">' +
          '<h1>تعذّر الوصول</h1>' +
          '<p>من دون الموافقة على إشعار حماية البيانات لا يمكنكم استخدام هذا الموقع.</p>' +
          '<p><button type="button" class="btn btn-primary js-gate-reread">إعادة قراءة الإشعار</button></p>' +
        '</div>' +
      '</div>';

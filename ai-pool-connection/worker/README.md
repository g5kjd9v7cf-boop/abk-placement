...
- Workers serve HTTPS by default.
- Set a strong password and keep provider keys in secrets only.
- This is a single-user gate; for multiple private users, add per-user accounts.
